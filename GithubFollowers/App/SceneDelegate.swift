...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createTabBar() -> UITabBarController {
        ...
        tabBarController.viewControllers = [createSearchVC(), createFavoritesVC()]
    ...
    func configureNavigationBar() {
        ...
        UIBarButtonItem.appearance(whenContainedInInstancesOf: [UISearchBar.self]).tintColor = .systemGreen
    }
